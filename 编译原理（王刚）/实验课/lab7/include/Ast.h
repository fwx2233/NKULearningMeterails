...
public:
    ...
    void setisinfunc(SymbolEntry *parent)
    {
        isinfunc = true;
        this->parent = parent;
    };
...
private:
    Id *id;
    ExprNode *expr;
    StmtNode* arrayDeclStmt=0;
public:
    Def(Id *id) : id(id), expr(0){};
    Def(Id *id, ExprNode *expr) : id(id), expr(expr){};
    Def(StmtNode* arrayDeclStmt):arrayDeclStmt(arrayDeclStmt){};
    void output(int level);
    void typeCheck(int level);
    void genCode();
    bool isConst();
...
class ArrayInits : public StmtNode
{
...
public:
    ArrayInits(int init, ArrayInits *inits = 0) : init(init), inits(inits){};
    void output(int level){};
    void typeCheck(int level){};
    void genCode(){};
    int getInit() { return init; };
    ArrayInits *getInits() { return inits; };
};
...
public:
    ArrayDef(ArrayInits *inits) : inits(inits){};
    void output(int level){};
    void typeCheck(int level){};
    void genCode();
    vector<int> *getInits() { return &initList; };
};

class ArrayDeclStmt : public DeclStmt
{
private:
    Id *id;
    int n;
...
public:
    ArrayDeclStmt(Id *id, int n, ArrayDef *def = 0) : id(id), n(n), def(def){};
    void output(int level){};
    void typeCheck(int level){};
    void genCode();
};

class ArrayMember : public ExprNode
{
private:
    Id *id;
    ExprNode* n;
...
public:
    ArrayMember(Id *id, ExprNode* n, SymbolEntry *se) : id(id), n(n), ExprNode(se)
    {
...
public:
    WhileStmt(ExprNode *cond, StmtNode *dostmt = nullptr) : cond(cond), dostmt(dostmt){};
    void output(int level);
    void typeCheck(int level);
    void genCode();
    void setDostmt(StmtNode *stmt) { this->dostmt = stmt; };
    void setCond(ExprNode *condExp) { this->cond = condExp; };
    BasicBlock *getCondbb() { return this->cond_bb; };
    BasicBlock *getThenbb() { return this->then_bb; };
...
public:
    BreakStmt(){};
    BreakStmt(StmtNode *stmt) : while_stmt(stmt){};
    void output(int level);
    void typeCheck(int level);
    void genCode();
};
...
public:
    ContinueStmt(){};
    ContinueStmt(StmtNode *stmt) : while_stmt(stmt){};
    void output(int level);
    void typeCheck(int level);
    void genCode();
};
