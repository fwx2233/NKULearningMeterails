...
public:
    enum condType { EQ, NE, L, LE , G, GE, NONE };
...
class ItMInstruction : public MachineInstruction
{
public:
    enum opType{EQ,NE,LT,GE,GT,LE,G,L};
    ItMInstruction(MachineBlock* p, int op);
    void output();
};
...
{
public:
    GlobalMInstruction(MachineBlock* p,MachineOperand*dst,MachineOperand*src);
    void frontoutput();
    void output();
};
