...
{
    // TODO
    // if(this->type == MachineInstruction::MOV)
    //     fprintf(yyout, "mov ");
    // else
    //     fprintf(yyout, "movs ");

    // still lots of mov instruction has not been included
    switch (this->op)
    {
...
void BranchMInstruction::output()
{
    ...
    switch (this->op)
    {
    case BranchMInstruction::BEQ:
        fprintf(yyout, "\tbeq ");
        break;
    case BranchMInstruction::BNE:
        fprintf(yyout, "\tbne ");
        break;
    case BranchMInstruction::BLT:
        fprintf(yyout, "\tblt ");
        break;
    case BranchMInstruction::BLE:
        fprintf(yyout, "\tble ");
        break;
    case BranchMInstruction::BGT:
        fprintf(yyout, "\tbgt ");
        break;
    case BranchMInstruction::BGE:
        fprintf(yyout, "\tbge ");
        break;
...
void MachineFunction::output()
{
   ...
   //prologue
   // we need save r4-r0, and reload them after function call
//    fprintf(yyout, "\tpush r4\n");
//    fprintf(yyout, "\tpush r5\n");
//    fprintf(yyout, "\tpush r6\n");
//    fprintf(yyout, "\tpush r7\n");
//    fprintf(yyout, "\tpush r8\n");
//    fprintf(yyout, "\tpush r9\n");
//    fprintf(yyout, "\tpush r10\n");
    // 1. Save fp
    fprintf(yyout, "\tpush {");
